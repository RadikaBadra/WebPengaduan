...
<br>
<form method ="POST" class="pilih-bulan">
    <label for="bulan">masukkan bulan</label><br>
    <input type="month" name="bulan" value="<?=isset($_POST['bulan']) ? $_POST['bulan'] :''?>"> 
    <button type="submit" formaction="<?=BASEURL.'/Admin/pilihan'?>">pilih</button>
    <button type="submit" formmethod="POST" formaction="<?=BASEURL.'/Admin/cetak'?>">cetak</button>
</form>
