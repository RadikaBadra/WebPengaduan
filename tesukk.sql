...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Sep 2021 pada 14.23
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `hitung_selesai` ()  NO SQL
SELECT * FROM pengaduan WHERE pengaduan.status$$
...
('123456', 'masyarakat1', 'masyarakat1', '827ccb0eea8a706c4c34a16891f84e7b', '12345');
...
(694651553, '2021-09-17', '123456', 'banjir', 'banjir bandang ', 'name tag.jpg', '0'),
(929552220, '2021-09-17', '123456', 'banjir', 'banjir di Denpasar', 'kelompok GAME DEV.jpg', 'selesai');
...
(13, 'admin1', 'admin1', '827ccb0eea8a706c4c34a16891f84e7b', 12345678, 'admin'),
(14, 'petugas1', 'petugas1', '827ccb0eea8a706c4c34a16891f84e7b', 12345678, 'petugas');
...
(1952460960, 929552220, '2021-09-17', 'siap', 14, 'petugas1');

--
-- Trigger `tanggapan`
--
DELIMITER $$
CREATE TRIGGER `status proses` AFTER INSERT ON `tanggapan` FOR EACH ROW UPDATE pengaduan SET
status = 'proses'
